...
public interface WishlistRepository extends JpaRepository<Wishlist, Long> {
    ...
    @Query("SELECT w FROM Wishlist w LEFT JOIN FETCH w.items WHERE w.active = TRUE AND w.publicId = :publicId")
    Optional<Wishlist> findByPublicIdAndActiveIsTrue(@NonNull String publicId);
    ...
    List<Wishlist> findByActiveTrueAndDeactivationDateBefore(ZonedDateTime dateTime);
}
